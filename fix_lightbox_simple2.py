...
# First remove the one I just inserted outside
lightbox_code = """
      {/* Logo Lightbox Modal */}
      {isLogoLightboxOpen && (
...
"""
content = content.replace(lightbox_code + "\nexport default function App()", "export default function App()")

# Now insert it right before the mobile nav closing
# Let's find: `</nav>`
# Wait, there are multiple `</nav>` tags in the app (e.g. desktop nav).
# Let's use something unique at the end of AppContent:
target = """        )}
      </nav>"""
